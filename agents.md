...
| **Formula Agent** | `4_Formula/` | Creates specs from requirements and simulations. Versions specs. Documents reasoning in `llm_thinking_log.md`. Creates and updates architectural plans as the project evolves. Gates entry to code. Creates synthesis sub-agents to merge upstream outputs and produce meaningful, coherent deliverables. | Environment Agent, Simulation Agent | Symbols Agent, all agents (via thinking log) |
...
| Formula Agent | Environment + Simulation output | `specs.md`, `decisions.md`, `dsl.md`, `extensions.md` | `llm_thinking_log.md` | Creates synthesis sub-agents, updates architectural plans as project evolves |
